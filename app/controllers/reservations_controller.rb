class ReservationsController < ApplicationController
	...
	def create
		...
		if @reservation
			...
			values = {
				business: 'munirchittagong-facilitator@gmail.com',
				cmd: '_xclick',
				upload: 1,
				notify_url: 'http://41188380.ngrok.io/notify',
				amount: @reservation.total, 
				item_name: @reservation.room.listing_name,
				item_number: @reservation.id,
				quantity: '1',
				return: 'http://41188380.ngrok.io/your_trips'
			}

			redirect_to "https://www.sandbox.paypal.com/cgi-bin/webscr?" + values.to_query
		else
			redirect_to @reservation.room, alert: "Opps, something went wrong...Reservation not completed"
		end
